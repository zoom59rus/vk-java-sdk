...
public class FaveRemoveProductQuery extends AbstractQueryBuilder<FaveRemoveProductQuery, OkResponse> {
     ...
     */
    public FaveRemoveProductQuery(VkApiClient client, UserActor actor, Long ownerId, Integer id) {
     ...
     * @param actor actor with access token
     */
    public FaveRemoveProductQuery(VkApiClient client, UserActor actor) {
        super(client, "fave.removeProduct", OkResponse.class);
        accessToken(actor.getAccessToken());
    }
     ...
     */
    @ApiParam("owner_id")
    public FaveRemoveProductQuery ownerId(Long value) {
     ...
     */
    @ApiParam("id")
    public FaveRemoveProductQuery id(Integer value) {
