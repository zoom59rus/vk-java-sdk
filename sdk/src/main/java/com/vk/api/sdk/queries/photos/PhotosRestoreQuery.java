...
public class PhotosRestoreQuery extends AbstractQueryBuilder<PhotosRestoreQuery, OkResponse> {
     ...
     */
    public PhotosRestoreQuery(VkApiClient client, UserActor actor, Integer photoId) {
     ...
     * @param actor actor with access token
     */
    public PhotosRestoreQuery(VkApiClient client, UserActor actor) {
        super(client, "photos.restore", OkResponse.class);
        accessToken(actor.getAccessToken());
    }
     ...
     */
    @ApiParam("owner_id")
    public PhotosRestoreQuery ownerId(Long value) {
     ...
     */
    @ApiParam("photo_id")
    public PhotosRestoreQuery photoId(Integer value) {
