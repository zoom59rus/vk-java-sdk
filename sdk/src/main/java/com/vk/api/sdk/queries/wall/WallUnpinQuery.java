...
public class WallUnpinQuery extends AbstractQueryBuilder<WallUnpinQuery, OkResponse> {
     ...
     */
    public WallUnpinQuery(VkApiClient client, UserActor actor, Integer postId) {
     ...
     * @param actor actor with access token
     */
    public WallUnpinQuery(VkApiClient client, UserActor actor) {
        super(client, "wall.unpin", OkResponse.class);
        accessToken(actor.getAccessToken());
    }
     ...
     */
    @ApiParam("owner_id")
    public WallUnpinQuery ownerId(Long value) {
     ...
     */
    @ApiParam("post_id")
    public WallUnpinQuery postId(Integer value) {
