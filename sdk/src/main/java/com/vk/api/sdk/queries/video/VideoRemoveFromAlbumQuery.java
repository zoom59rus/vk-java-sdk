 ...
 */
public class VideoRemoveFromAlbumQuery extends AbstractQueryBuilder<VideoRemoveFromAlbumQuery, List<Integer>> {
    /**
     ...
     */
    public VideoRemoveFromAlbumQuery(VkApiClient client, UserActor actor, Long ownerId,
            Integer videoId) {
        super(client, "video.removeFromAlbum", Utils.buildParametrizedType(List.class, Integer.class));
     ...
     * @param actor actor with access token
     */
    public VideoRemoveFromAlbumQuery(VkApiClient client, UserActor actor) {
        super(client, "video.removeFromAlbum", Utils.buildParametrizedType(List.class, Integer.class));
        accessToken(actor.getAccessToken());
    }
     ...
     */
    @ApiParam("target_id")
    public VideoRemoveFromAlbumQuery targetId(Long value) {
     ...
     */
    @ApiParam("owner_id")
    public VideoRemoveFromAlbumQuery ownerId(Long value) {
     ...
     */
    @ApiParam("video_id")
    public VideoRemoveFromAlbumQuery videoId(Integer value) {
