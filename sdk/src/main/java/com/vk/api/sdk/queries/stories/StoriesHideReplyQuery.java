...
public class StoriesHideReplyQuery extends AbstractQueryBuilder<StoriesHideReplyQuery, OkResponse> {
     ...
     */
    public StoriesHideReplyQuery(VkApiClient client, GroupActor actor, Long ownerId,
            Integer storyId) {
     ...
     * @param actor actor with access token
     */
    public StoriesHideReplyQuery(VkApiClient client, GroupActor actor) {
        super(client, "stories.hideReply", OkResponse.class);
        accessToken(actor.getAccessToken());
    }
     ...
     * @param storyId value of "story id" parameter. Minimum is 0.
     */
    public StoriesHideReplyQuery(VkApiClient client, UserActor actor, Long ownerId,
            Integer storyId) {
        super(client, "stories.hideReply", OkResponse.class);
        accessToken(actor.getAccessToken());
        ownerId(ownerId);
     ...
     * @param actor actor with access token
     */
    public StoriesHideReplyQuery(VkApiClient client, UserActor actor) {
        super(client, "stories.hideReply", OkResponse.class);
        accessToken(actor.getAccessToken());
    }
     ...
     */
    @ApiParam("owner_id")
    public StoriesHideReplyQuery ownerId(Long value) {
     ...
     */
    @ApiParam("story_id")
    public StoriesHideReplyQuery storyId(Integer value) {
