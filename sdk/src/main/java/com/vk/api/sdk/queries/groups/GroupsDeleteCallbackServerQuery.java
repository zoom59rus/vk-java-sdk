...
public class GroupsDeleteCallbackServerQuery extends AbstractQueryBuilder<GroupsDeleteCallbackServerQuery, OkResponse> {
     ...
     */
    public GroupsDeleteCallbackServerQuery(VkApiClient client, GroupActor actor, Long groupId,
            Integer serverId) {
     ...
     * @param actor actor with access token
     */
    public GroupsDeleteCallbackServerQuery(VkApiClient client, GroupActor actor) {
        super(client, "groups.deleteCallbackServer", OkResponse.class);
        accessToken(actor.getAccessToken());
        groupId(actor.getGroupId());
    }
     ...
     * @param serverId value of "server id" parameter. Minimum is 0.
     */
    public GroupsDeleteCallbackServerQuery(VkApiClient client, UserActor actor, Long groupId,
            Integer serverId) {
        super(client, "groups.deleteCallbackServer", OkResponse.class);
        accessToken(actor.getAccessToken());
        groupId(groupId);
     ...
     * @param actor actor with access token
     */
    public GroupsDeleteCallbackServerQuery(VkApiClient client, UserActor actor) {
        super(client, "groups.deleteCallbackServer", OkResponse.class);
        accessToken(actor.getAccessToken());
    }
     ...
     */
    @ApiParam("group_id")
    public GroupsDeleteCallbackServerQuery groupId(Long value) {
     ...
     */
    @ApiParam("server_id")
    public GroupsDeleteCallbackServerQuery serverId(Integer value) {
