...
public class LikesAddQuery extends AbstractQueryBuilder<LikesAddQuery, AddResponse> {
     ...
     */
    public LikesAddQuery(VkApiClient client, UserActor actor, Type type, Integer itemId) {
     ...
     * @param actor actor with access token
     */
    public LikesAddQuery(VkApiClient client, UserActor actor) {
        super(client, "likes.add", AddResponse.class);
        accessToken(actor.getAccessToken());
    }
     ...
     */
    @ApiParam("type")
    public LikesAddQuery type(Type value) {
     ...
     */
    @ApiParam("owner_id")
    public LikesAddQuery ownerId(Long value) {
     ...
     */
    @ApiParam("item_id")
    public LikesAddQuery itemId(Integer value) {
