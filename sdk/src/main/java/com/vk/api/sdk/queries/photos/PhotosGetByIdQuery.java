 ...
 */
public class PhotosGetByIdQuery extends AbstractQueryBuilder<PhotosGetByIdQuery, List<GetByIdResponse>> {
    /**
    ...
    public PhotosGetByIdQuery(VkApiClient client, ServiceActor actor, String... photos) {
        super(client, "photos.getById", Utils.buildParametrizedType(List.class, GetByIdResponse.class));
     ...
     * @param actor actor with access token
     */
    public PhotosGetByIdQuery(VkApiClient client, ServiceActor actor) {
        super(client, "photos.getById", Utils.buildParametrizedType(List.class, GetByIdResponse.class));
        accessToken(actor.getAccessToken());
        clientSecret(actor.getClientSecret());
    }
     ...
     * @param actor actor with access token
     */
    public PhotosGetByIdQuery(VkApiClient client, UserActor actor) {
        super(client, "photos.getById", Utils.buildParametrizedType(List.class, GetByIdResponse.class));
        accessToken(actor.getAccessToken());
    }
     ...
     */
    @ApiParam("photos")
    public PhotosGetByIdQuery photos(String... value) {
     ...
     */
    @ApiParam("photos")
    public PhotosGetByIdQuery photos(List<String> value) {
        return unsafeParam("photos", value);
    }
