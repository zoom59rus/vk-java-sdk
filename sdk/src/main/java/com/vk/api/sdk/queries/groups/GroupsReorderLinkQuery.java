...
public class GroupsReorderLinkQuery extends AbstractQueryBuilder<GroupsReorderLinkQuery, OkResponse> {
     ...
     */
    public GroupsReorderLinkQuery(VkApiClient client, UserActor actor, Long groupId,
            Integer linkId) {
     ...
     * @param actor actor with access token
     */
    public GroupsReorderLinkQuery(VkApiClient client, UserActor actor) {
        super(client, "groups.reorderLink", OkResponse.class);
        accessToken(actor.getAccessToken());
    }
     ...
     */
    @ApiParam("group_id")
    public GroupsReorderLinkQuery groupId(Long value) {
     ...
     */
    @ApiParam("link_id")
    public GroupsReorderLinkQuery linkId(Integer value) {
