...
public class GroupsGetLongPollServerQuery extends AbstractQueryBuilder<GroupsGetLongPollServerQuery, GetLongPollServerResponse> {
     ...
     *
     */
    public GroupsGetLongPollServerQuery(VkApiClient client, GroupActor actor, Long groupId) {
     ...
     *
     */
    public GroupsGetLongPollServerQuery(VkApiClient client, UserActor actor, Long groupId) {
        super(client, "groups.getLongPollServer", GetLongPollServerResponse.class);
        accessToken(actor.getAccessToken());
        groupId(groupId);
    }
     ...
     * @param actor actor with access token
     */
    public GroupsGetLongPollServerQuery(VkApiClient client, UserActor actor) {
        super(client, "groups.getLongPollServer", GetLongPollServerResponse.class);
        accessToken(actor.getAccessToken());
    }
     ...
     */
    @ApiParam("group_id")
    public GroupsGetLongPollServerQuery groupId(Long value) {
