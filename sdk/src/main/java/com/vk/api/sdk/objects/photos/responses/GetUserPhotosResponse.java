 ...
 */
public class GetUserPhotosResponse implements Validable {
    /**
     * Total number
     */
    ...
    public GetUserPhotosResponse setCount(Integer count) {
        this.count = count;
        return this;
    }
    ...
    public GetUserPhotosResponse setItems(List<Photo> items) {
        this.items = items;
        return this;
    }
