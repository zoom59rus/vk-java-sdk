...
import com.vk.api.sdk.queries.wall.*;
...
public class Wall extends AbstractAction {
     ...
     * @return query
     */
    @ApiMethod("wall.parseAttachedLink")
    public WallParseAttachedLinkQuery parseAttachedLink(UserActor actor, JsonObject... links) {
        return new WallParseAttachedLinkQuery(getClient(), actor, links);
    }
     ...
     */
    @ApiMethod("wall.parseAttachedLink")
    public WallParseAttachedLinkQuery parseAttachedLink(UserActor actor, List<JsonObject> links) {
        return new WallParseAttachedLinkQuery(getClient(), actor, links);
    }
     ...
     */
    @ApiMethod("wall.parseAttachedLink")
    public WallParseAttachedLinkQuery parseAttachedLink(UserActor actor) {
        return new WallParseAttachedLinkQuery(getClient(), actor);
    }
    ...
    public WallReportCommentQuery reportComment(UserActor actor, Long ownerId, Integer commentId,
        ...
        return new WallReportCommentQuery(getClient(), actor, ownerId, commentId, reason);
    }
    ...
    public WallReportPostQuery reportPost(UserActor actor, Long ownerId, Integer postId,
        ...
        return new WallReportPostQuery(getClient(), actor, ownerId, postId, reason);
    }
