...
public class MarketGetByIdQuery extends AbstractQueryBuilder<MarketGetByIdQuery, GetByIdResponse> {
     ...
     * @param actor actor with access token
     */
    public MarketGetByIdQuery(VkApiClient client, UserActor actor) {
        super(client, "market.getById", GetByIdResponse.class);
        accessToken(actor.getAccessToken());
    }
     ...
     */
    @ApiParam("item_ids")
    public MarketGetByIdQuery itemIds(String... value) {
     ...
     */
    @ApiParam("item_ids")
    public MarketGetByIdQuery itemIds(List<String> value) {
        return unsafeParam("item_ids", value);
    }
