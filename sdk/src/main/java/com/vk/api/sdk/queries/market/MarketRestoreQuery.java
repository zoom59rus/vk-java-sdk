...
public class MarketRestoreQuery extends AbstractQueryBuilder<MarketRestoreQuery, OkResponse> {
     ...
     */
    public MarketRestoreQuery(VkApiClient client, UserActor actor, Long ownerId, Integer itemId) {
     ...
     * @param actor actor with access token
     */
    public MarketRestoreQuery(VkApiClient client, UserActor actor) {
        super(client, "market.restore", OkResponse.class);
        accessToken(actor.getAccessToken());
    }
     ...
     */
    @ApiParam("owner_id")
    public MarketRestoreQuery ownerId(Long value) {
     ...
     */
    @ApiParam("item_id")
    public MarketRestoreQuery itemId(Integer value) {
