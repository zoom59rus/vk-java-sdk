...
public class BoardOpenTopicQuery extends AbstractQueryBuilder<BoardOpenTopicQuery, OkResponse> {
     ...
     */
    public BoardOpenTopicQuery(VkApiClient client, UserActor actor, Long groupId, Integer topicId) {
     ...
     * @param actor actor with access token
     */
    public BoardOpenTopicQuery(VkApiClient client, UserActor actor) {
        super(client, "board.openTopic", OkResponse.class);
        accessToken(actor.getAccessToken());
    }
     ...
     */
    @ApiParam("group_id")
    public BoardOpenTopicQuery groupId(Long value) {
     ...
     */
    @ApiParam("topic_id")
    public BoardOpenTopicQuery topicId(Integer value) {
