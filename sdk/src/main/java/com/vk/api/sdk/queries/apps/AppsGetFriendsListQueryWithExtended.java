...
public class AppsGetFriendsListQueryWithExtended extends AbstractQueryBuilder<AppsGetFriendsListQueryWithExtended, GetFriendsListExtendedResponse> {
     ...
     */
    public AppsGetFriendsListQueryWithExtended(VkApiClient client, UserActor actor) {
        super(client, "apps.getFriendsList", GetFriendsListExtendedResponse.class);
     ...
     */
    @ApiParam("extended")
    protected AppsGetFriendsListQueryWithExtended extended(Boolean value) {
     ...
     */
    @ApiParam("count")
    public AppsGetFriendsListQueryWithExtended count(Integer value) {
     ...
     */
    @ApiParam("offset")
    public AppsGetFriendsListQueryWithExtended offset(Integer value) {
     ...
     */
    @ApiParam("type")
    public AppsGetFriendsListQueryWithExtended type(GetFriendsListType value) {
     ...
     */
    @ApiParam("query")
    public AppsGetFriendsListQueryWithExtended query(String value) {
     ...
     */
    @ApiParam("fields")
    public AppsGetFriendsListQueryWithExtended fields(Fields... value) {
     ...
     */
    @ApiParam("fields")
    public AppsGetFriendsListQueryWithExtended fields(List<Fields> value) {
        return unsafeParam("fields", value);
    }

    @Override
    protected AppsGetFriendsListQueryWithExtended getThis() {
        return this;
    }
